...
function! MyToggleNERDTreeFind2()
  NERDTreeFind
endfunction
noremap <silent> <leader>t :call MyToggleNERDTreeFind()<CR>
noremap <silent> <leader>x :call MyToggleNERDTreeFind2()<CR>
...
" disable blinking for all modes (the "a" specifies all modes, and the 0 value
" for blinkon disables blinking):
" If you want the window as big as possible, you can set these options to very
" large values: https://github.com/b4winckler/macvim/wiki/FAQ
""""""""""""""""""""""""""" self
"imap <C-I> <Esc>
" snipemate
...
"glyph characters
"exm: let g:javascript_conceal_arrow_function  = "⇒"
set conceallevel=1
